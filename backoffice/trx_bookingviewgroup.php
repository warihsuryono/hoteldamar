...
<?php 
	...
	$sql="SELECT roomtipe,jmlkamar FROM trx_booking WHERE kode='$kode'";
	$hsltemp=mysql_query($sql,$db);
	list($roomtipe,$jmlkamar)=mysql_fetch_array($hsltemp);
?>
...
<?php if ($trx_booking->room->Visible) { // room ?>
	<tr<?php echo $trx_booking->room->RowAttributes ?>>
		<td class="ewTableHeader">Tipe Kamar</td>
		<td<?php echo $trx_booking->room->CellAttributes() ?>>
<div<?php echo $trx_booking->room->ViewAttributes() ?>><?php echo $roomtipe; ?></div></td>
	</tr>
<?php } ?>

<?php if ($trx_booking->person->Visible) { // person ?>
	<tr<?php echo $trx_booking->person->RowAttributes ?>>
		<td class="ewTableHeader">Pax</td>
...
<?php if ($trx_booking->room->Visible) { // room ?>
	<tr<?php echo $trx_booking->room->RowAttributes ?>>
		<td class="ewTableHeader">Jml Kamar</td>
		<td<?php echo $trx_booking->room->CellAttributes() ?>>
<div<?php echo $trx_booking->room->ViewAttributes() ?>><?php echo $jmlkamar; ?></div></td>
	</tr>
<?php } ?>
