	...
	<table width="100%">
		<tr>
			<td align="center">
				...
				<input type="button" value="Daftar Penerimaan Quotation" id="btnrecvqrlist" onclick="window.open('logistik_qr_vendorlist.php?qrno='+qrno.innerHTML,'logistik_qr_vendorlist','width=1000,height=800,scrollbars=yes');">
				<input type="button" value="Terima Quotation" id="btnrecvqr" onclick="window.open('logistik_qr_vendoradd.php?qrno='+qrno.innerHTML,'logistik_qr_vendoradd','width=1000,height=800,scrollbars=yes');">
			</td>
		</tr>
	</table>
<?php
