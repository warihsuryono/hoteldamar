	...
	<form method="POST" action="<?php echo $__phpself; ?>?editing=<?php echo $_GET["editing"];?>&kode=<?php echo $_GET["kode"]; ?>">
		...
		<table>
			...
			<tr>
				<td>Footer</td>
				<td>:</td>
				<td><textarea name="footer" id="footer" cols="50" rows="2"></textarea></td>
			</tr>
		</table>
		<table class="content_table" width="100%" id="tabledetail">
			...
			<tr id="rowdetail" class="content_ganjil">
				...
				<td>
					<textarea cols="60" rows="2" id="coa[0]" type="text" name="coa[0]" size="20"></textarea>
					<img src="images/b_search.png" title="Daftar COA" border="0" width="13" height="13"  onclick="showCOA('coa[0]','','','add')">
				</td>
				<td>
					<select id="modevalue[0]" name="modevalue[0]">
						<option value=""></option>
				...
				<td><input id="alias[0]" type="text" name="alias[0]" size="40"></td>
			</tr>
		</table>		
