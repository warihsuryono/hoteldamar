...
// Database connection
define("EW_CONN_HOST", $host, TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", $user, TRUE);
define("EW_CONN_PASS", $pass, TRUE);
...
define("EW_PROJECT_NAME", "hotel damar", TRUE); // Project Name
define("EW_RANDOM_KEY", 'C4jt3d4Wym0mem0h', TRUE); // Random key for encryption
