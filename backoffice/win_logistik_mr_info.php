...
// PHPMaker 6 configuration for Table win_logistik_mr_
$win_logistik_mr_ = NULL; // Initialize table object

// Define table class
class cwin_logistik_mr_ {
	...
	function cwin_logistik_mr_() {
		$this->TableVar = "win_logistik_mr_";
		$this->TableName = "win_logistik_mr_";
		$this->mrno = new cField('win_logistik_mr_', 'x_mrno', 'mrno', "logistik_mr.mrno", 200, -1, FALSE);
		$this->fields['mrno'] =& $this->mrno;
		$this->kode_pekerjaan = new cField('win_logistik_mr_', 'x_kode_pekerjaan', 'kode_pekerjaan', "logistik_mr.kode_pekerjaan", 200, -1, FALSE);
		$this->fields['kode_pekerjaan'] =& $this->kode_pekerjaan;
		$this->tanggal = new cField('win_logistik_mr_', 'x_tanggal', 'tanggal', "logistik_mr.tanggal", 133, 7, FALSE);
		$this->fields['tanggal'] =& $this->tanggal;
		$this->periode = new cField('win_logistik_mr_', 'x_periode', 'periode', "logistik_mr.periode", 133, 7, FALSE);
		$this->fields['periode'] =& $this->periode;
		$this->peruntukan = new cField('win_logistik_mr_', 'x_peruntukan', 'peruntukan', "logistik_mr.peruntukan", 200, -1, FALSE);
		$this->fields['peruntukan'] =& $this->peruntukan;
		$this->gudang = new cField('win_logistik_mr_', 'x_gudang', 'gudang', "logistik_mr.gudang", 200, -1, FALSE);
		$this->fields['gudang'] =& $this->gudang;
		$this->createby = new cField('win_logistik_mr_', 'x_createby', 'createby', "logistik_mr.createby", 200, -1, FALSE);
	...
	function HighlightName() {
		return "win_logistik_mr__Highlight";
	}
	...
	function SqlSelect() { // Select
		return "SELECT logistik_mr.mrno, logistik_mr.kode_pekerjaan, logistik_mr.tanggal, logistik_mr.periode, logistik_mr.peruntukan, logistik_mr.gudang, logistik_mr.createby FROM logistik_mr";
	}
	...
	function SqlOrderBy() { // Order By
		return "logistik_mr.mrno Desc, logistik_mr.tanggal Desc";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[EW_PROJECT_NAME . "_" . $this->TableVar . "_" . EW_TABLE_RETURN_URL] <> "") {
			...
			return "win_logistik_mr_list.php";
		}
	}
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("win_logistik_mr_view.php", $this->UrlParm());
	}

	// Add url
	function AddUrl() {
		$AddUrl = "win_logistik_mr_add.php";
	...
	// Edit url
	function EditUrl() {
		return $this->KeyUrl("win_logistik_mr_edit.php", $this->UrlParm());
	}
	...
	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("win_logistik_mr_add.php", $this->UrlParm());
	}
	...
	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("win_logistik_mr_delete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=win_logistik_mr_" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
