<?php
	...
	if($_GET["editing"]){
		$sql="SELECT dirutby FROM $tablename WHERE $kodename='".$_GET["kode"]."'";
		$hsltemp=mysql_query($sql,$db);
	...
	if($modebutton=="simpan"){
		...
		$actionlink="<a href=''$__phpself?editing=1&kode=$kodejurnal''><img src=''images/inlineedit.gif'' title=''Inline Edit'' width=''16'' height=''16'' border=''0''></a>";
