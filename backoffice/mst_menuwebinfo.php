...
// PHPMaker 6 configuration for Table mst_menuweb
$mst_menuweb = NULL; // Initialize table object
...
class cmst_menuweb {
	...
	function cmst_menuweb() {
		$this->TableVar = "mst_menuweb";
		$this->TableName = "mst_menuweb";
		$this->SelectLimit = TRUE;
		$this->kode = new cField('mst_menuweb', 'x_kode', 'kode', "`kode`", 3, -1, FALSE);
		$this->fields['kode'] =& $this->kode;
		$this->seqno = new cField('mst_menuweb', 'x_seqno', 'seqno', "`seqno`", 3, -1, FALSE);
		$this->fields['seqno'] =& $this->seqno;
		$this->lang = new cField('mst_menuweb', 'x_lang', 'lang', "`lang`", 200, -1, FALSE);
		$this->fields['lang'] =& $this->lang;
		$this->caption = new cField('mst_menuweb', 'x_caption', 'caption', "`caption`", 200, -1, FALSE);
		$this->fields['caption'] =& $this->caption;
		$this->url = new cField('mst_menuweb', 'x_url', 'url', "`url`", 200, -1, FALSE);
		$this->fields['url'] =& $this->url;
		$this->target = new cField('mst_menuweb', 'x_target', 'target', "`target`", 200, -1, FALSE);
		$this->fields['target'] =& $this->target;
		$this->content = new cField('mst_menuweb', 'x_content', 'content', "`content`", 201, -1, FALSE);
		$this->fields['content'] =& $this->content;
		$this->createby = new cField('mst_menuweb', 'x_createby', 'createby', "`createby`", 200, -1, FALSE);
		$this->fields['createby'] =& $this->createby;
		$this->createdate = new cField('mst_menuweb', 'x_createdate', 'createdate', "`createdate`", 135, 11, FALSE);
		$this->fields['createdate'] =& $this->createdate;
		$this->xtimestamp = new cField('mst_menuweb', 'x_xtimestamp', 'xtimestamp', "`xtimestamp`", 135, 7, FALSE);
	...
	function SqlSelect() { // Select
		return "SELECT * FROM `mst_menuweb`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `mst_menuweb` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		$SQL = "UPDATE `mst_menuweb` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `mst_menuweb` WHERE ";
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("mst_menuwebview.php", $this->UrlParm());
	}

	// Add url
	function AddUrl() {
		$AddUrl = "mst_menuwebadd.php";
	...
	// Edit url
	function EditUrl() {
		return $this->KeyUrl("mst_menuwebedit.php", $this->UrlParm());
	}
	...
	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("mst_menuwebadd.php", $this->UrlParm());
	}
	...
	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("mst_menuwebdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=mst_menuweb" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function RenderListRow() {
		...
		if (strval($this->lang->CurrentValue) <> "") {
			switch ($this->lang->CurrentValue) {
				case "ind":
					$this->lang->ViewValue = "Indonesia";
					break;
				case "eng":
					$this->lang->ViewValue = "English";
					break;
				default:
		...
		$this->caption->CssStyle = "";
		$this->caption->CssClass = "";
		...
		if (strval($this->target->CurrentValue) <> "") {
			switch ($this->target->CurrentValue) {
				case "main_frame":
					$this->target->ViewValue = "Same Window";
					break;
				case "_blank":
					$this->target->ViewValue = "New Window";
					break;
				default:
		...
		$this->target->CssStyle = "";
		$this->target->CssClass = "";
		...
		$this->createdate->ViewValue = ew_FormatDateTime($this->createdate->ViewValue, 11);
